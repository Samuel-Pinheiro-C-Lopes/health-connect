...
public class PatientController {
	...
	@PreAuthorize("hasAuthority(@rolesConfiguration.admin) or hasAuthority(@rolesConfiguration.manager) or hasAuthority(@rolesConfiguration.doctor)")
	public ResponseEntity<PatientDetailsResponseDTO> findDetailsById(@PathVariable final Long id) {
		return ResponseEntity.ok(this.patientService.findDetailsById(id));
	}
